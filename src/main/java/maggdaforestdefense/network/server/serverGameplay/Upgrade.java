...
public enum Upgrade {
    ...
    SPRUCE_2_1(GameImage.UPGRADE_SPRUCE_01_01.getImage(), "Aufruestung", 400, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_2_1;})),
    ...
    SPRUCE_2_5(GameImage.UPGRADE_SPRUCE_01_01.getImage(), "Erbarmungslose Fichte", 400, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_2_5;})),
    ...
    SPRUCE_3_3(GameImage.UPGRADE_SPRUCE_01_01.getImage(), "Riesenschreck", 1000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_3_3;})),
    ...
    SPRUCE_3_5(GameImage.UPGRADE_SPRUCE_01_01.getImage(), "Dominierende Nadeln", 1000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_3_5;})),
