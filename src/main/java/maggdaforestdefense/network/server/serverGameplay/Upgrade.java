...
public enum Upgrade {
    ...
    SPRUCE_3_1(GameImage.UPGRADE_SPRUCE_03_01.getImage(), "Serienmörder", 1700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_3_1;}), GameObjectType.T_SPRUCE),
