...
public enum Upgrade {
    ...
    SPRUCE_1_3(GameImage.UPGRADE_SPRUCE_01_03.getImage(), "Rüstungsdurchdringende Nadeln", 1, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_1_3;})),
    SPRUCE_1_4(GameImage.UPGRADE_SPRUCE_01_04.getImage(), "Höher wachsen", 1, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_1_4;})),
    SPRUCE_1_5(GameImage.UPGRADE_SPRUCE_01_05.getImage(), "Nadelstärkung", 1, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_1_5;})),
    ...
    SPRUCE_3_1(GameImage.UPGRADE_SPRUCE_03_01.getImage(), "Serienmörder", 1, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_3_1;})),
