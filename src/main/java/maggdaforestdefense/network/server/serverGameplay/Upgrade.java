...
public enum Upgrade {
    ...
    SPRUCE_3_1(GameImage.UPGRADE_SPRUCE_03_01.getImage(), "Serienmörder", 2000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_3_1;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_2(GameImage.UPGRADE_SPRUCE_03_02.getImage(), "Rasende Fichte", 2000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_3_2;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_3(GameImage.UPGRADE_SPRUCE_03_03.getImage(), "Riesenschreck", 2000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_3_3;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_4(GameImage.UPGRADE_SPRUCE_03_04.getImage(), "Fichtenforschung", 2000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_3_4;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_5(GameImage.UPGRADE_SPRUCE_03_05.getImage(), "Dominierende Nadeln", 2000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_3_5;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_6(GameImage.UPGRADE_SPRUCE_03_06.getImage(), "Aufruhr der Fichten", 2000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_3_6;}), GameObjectType.T_SPRUCE),
    ...
    LORBEER_1_1(GameImage.UPGRADE_LORBEER_01_01.getImage(), "Weitreichende Ernte", 500, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_1_1;}), GameObjectType.T_LORBEER),
    LORBEER_1_2(GameImage.UPGRADE_LORBEER_01_02.getImage(), "Ertragreiche Ernte", 500, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_1_2;}), GameObjectType.T_LORBEER),
    LORBEER_1_3(GameImage.UPGRADE_LORBEER_01_03.getImage(), "Effizientere Ernte", 500, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_1_3;}), GameObjectType.T_LORBEER),
    LORBEER_1_4(GameImage.UPGRADE_LORBEER_01_04.getImage(), "Vorrats-Ernte", 500, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_1_4;}), GameObjectType.T_LORBEER),
    LORBEER_2_1(GameImage.UPGRADE_LORBEER_02_01.getImage(), "Brutale Ernte", 2000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_2_1;}), GameObjectType.T_LORBEER),
    LORBEER_2_2(GameImage.UPGRADE_LORBEER_02_02.getImage(), "Ernterausch", 2000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_2_2;}), GameObjectType.T_LORBEER),
    LORBEER_2_3(GameImage.UPGRADE_LORBEER_02_03.getImage(), "Massenproduktion", 2000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_2_3;}), GameObjectType.T_LORBEER),
    LORBEER_2_4(GameImage.UPGRADE_LORBEER_02_04.getImage(), "Wiederverwertung", 2000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_2_4;}), GameObjectType.T_LORBEER),
    LORBEER_3_1(GameImage.UPGRADE_LORBEER_03_01.getImage(), "Mechanische Ernte", 10000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_3_1;}), GameObjectType.T_LORBEER),
    LORBEER_3_2(GameImage.UPGRADE_LORBEER_03_02.getImage(), "Prestige Ernte", 10000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_3_2;}), GameObjectType.T_LORBEER),
    LORBEER_3_3(GameImage.UPGRADE_LORBEER_03_03.getImage(), "Kopfgeld Ernte", 10000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_3_3;}), GameObjectType.T_LORBEER),
    LORBEER_3_4(GameImage.UPGRADE_LORBEER_03_04.getImage(), "Tauschhandel", 10000, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_LORBEER_3_4;}), GameObjectType.T_LORBEER);
