...
public enum Upgrade {
    ...
    // SPRUCESPRUCE_1_6(GameImage.UPGRADE_SPRUCE_01_06.getImage(), "Lebenskristall", 50, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_1_6;})),
    SPRUCE_1_1(GameImage.UPGRADE_SPRUCE_01_01.getImage(), "Nadel Teilung", 150, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_1_1;}), GameObjectType.T_SPRUCE),
    SPRUCE_1_2(GameImage.UPGRADE_SPRUCE_01_02.getImage(), "Fichten-Monokultur", 150, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_1_2;}), GameObjectType.T_SPRUCE),
    SPRUCE_1_3(GameImage.UPGRADE_SPRUCE_01_03.getImage(), "R¸stungsdurchdringende Nadeln", 150, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_1_3;}), GameObjectType.T_SPRUCE),
    SPRUCE_1_4(GameImage.UPGRADE_SPRUCE_01_04.getImage(), "Hˆher wachsen", 150, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_1_4;}), GameObjectType.T_SPRUCE),
    SPRUCE_1_5(GameImage.UPGRADE_SPRUCE_01_05.getImage(), "Nadelst‰rkung", 150, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_1_5;}), GameObjectType.T_SPRUCE),
    SPRUCE_1_6(GameImage.UPGRADE_SPRUCE_01_06.getImage(), "Lebensraub", 150, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_1_6;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_1(GameImage.UPGRADE_SPRUCE_02_01.getImage(), "Aufruestung", 550, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_2_1;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_2(GameImage.UPGRADE_SPRUCE_02_02.getImage(), "Fichten-Wut", 550, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_2_2;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_3(GameImage.UPGRADE_SPRUCE_02_03.getImage(), "Kritische Nadeln", 550, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_2_3;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_4(GameImage.UPGRADE_SPRUCE_02_04.getImage(), "Wurzelhieb", 550, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_2_4;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_5(GameImage.UPGRADE_SPRUCE_02_05.getImage(), "Erbarmungslose Fichte", 550, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_2_5;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_6(GameImage.UPGRADE_SPRUCE_02_06.getImage(), "Fichtenfreundschaft", 550, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_2_6;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_1(GameImage.UPGRADE_SPRUCE_03_01.getImage(), "Serienmˆrder", 1700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_3_1;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_2(GameImage.UPGRADE_SPRUCE_03_02.getImage(), "Rasende Fichte", 1700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_3_2;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_3(GameImage.UPGRADE_SPRUCE_03_03.getImage(), "Riesenschreck", 1700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_3_3;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_4(GameImage.UPGRADE_SPRUCE_03_04.getImage(), "Fichtenforschung", 1700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_3_4;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_5(GameImage.UPGRADE_SPRUCE_03_05.getImage(), "Dominierende Nadeln", 1700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_3_5;}), GameObjectType.T_SPRUCE),
    SPRUCE_3_6(GameImage.UPGRADE_SPRUCE_03_06.getImage(), "Aufruhr der Fichten", 1700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPRUCE_3_6;}), GameObjectType.T_SPRUCE),
    ...
    MAPLE_2_3(GameImage.UPGRADE_MAPLE_02_03.getImage(), "Erschˆpfende Bl‰tter", 500, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_MAPLE_2_3;}), GameObjectType.T_MAPLE),
    ...
    private Upgrade(Image i, String n, int p, LanguageFetcher descriptionFetcher, GameObjectType owner) {
        icon = i;
        name = n;
        prize = p; // ngr das heiﬂt price nicht prize (wenn sie schon nicht cost schreiben wollen lollen)
