...
public class Borkenkaefer extends Bug {
    ...
    public Borkenkaefer(ServerGame serverGame, int waveIndex) {
        super(serverGame, HP * Bug.calculateHpWaveFactor(waveIndex), SPEED, TOWER_VISION_RANGE, DAMAGE, ATTACK_TIME, MAP_DISTANCES, ARMOR, MOVEMENT_TYPE, GameObjectType.M_BORKENKAEFER);
    }
