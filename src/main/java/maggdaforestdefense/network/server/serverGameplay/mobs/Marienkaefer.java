...
public class Marienkaefer extends Bug{
    ...
    public Marienkaefer(ServerGame serverGame) {
        super(serverGame, HP, SPEED, TOWER_VISION_RANGE, DAMAGE, ATTACK_TIME, MAP_DISTANCES, ARMOR, MOVEMENT_TYPE, GameObjectType.M_MARIENKAEFER);
    }
