...
public enum Upgrade {
    ...
    SPRUCE_1_3(GameImage.UPGRADE_SPRUCE_01_03.getImage(), "Rüstungsdurchdringende Nadeln", 150, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_1_3;}), GameObjectType.T_SPRUCE),
    SPRUCE_1_4(GameImage.UPGRADE_SPRUCE_01_04.getImage(), "Höher wachsen", 150, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_1_4;}), GameObjectType.T_SPRUCE),
    SPRUCE_1_5(GameImage.UPGRADE_SPRUCE_01_05.getImage(), "Nadelstärkung", 150, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_1_5;}), GameObjectType.T_SPRUCE),
    ...
    SPRUCE_2_1(GameImage.UPGRADE_SPRUCE_02_01.getImage(), "Aufruestung", 700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_2_1;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_2(GameImage.UPGRADE_SPRUCE_02_02.getImage(), "Fichten-Wut", 700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_2_2;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_3(GameImage.UPGRADE_SPRUCE_02_03.getImage(), "Kritische Nadeln", 700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_2_3;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_4(GameImage.UPGRADE_SPRUCE_02_04.getImage(), "Wurzelhieb", 700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_2_4;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_5(GameImage.UPGRADE_SPRUCE_02_05.getImage(), "Erbarmungslose Fichte", 700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_2_5;}), GameObjectType.T_SPRUCE),
    SPRUCE_2_6(GameImage.UPGRADE_SPRUCE_02_06.getImage(), "Fichtenfreundschaft", 700, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_SPURCE_2_6;}), GameObjectType.T_SPRUCE),
    ...
    MAPLE_3_1(GameImage.UPGRADE_MAPLE_03_01.getImage(), "Zerschmetternde Blätter", 1200, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_MAPLE_3_1;}), GameObjectType.T_MAPLE),
    MAPLE_3_2(GameImage.UPGRADE_MAPLE_03_02.getImage(), "Gnadenlose Blätter", 1200, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_MAPLE_3_2;}), GameObjectType.T_MAPLE),
    MAPLE_3_3(GameImage.UPGRADE_MAPLE_03_03.getImage(), "Zerlegende Blätter", 1200, (() -> {return Game.getInstance().language.UPGRADE_DESCRIPTION_MAPLE_3_3;}), GameObjectType.T_MAPLE),
